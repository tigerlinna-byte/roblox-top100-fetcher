...
class RobloxCreatorMetricsClientTests(unittest.TestCase):
    ...
    def test_resolve_project_metrics_query_date_bounds_uses_soccer_tycoon_start_date(self) -> None:
        mocked_midnight = datetime(2026, 7, 8, 0, 0, tzinfo=timezone.utc)

        with patch("app.roblox_creator_metrics_client._business_midnight_now", return_value=mocked_midnight):
            bounds = resolve_project_metrics_query_date_bounds("10403337696", "UTC")
